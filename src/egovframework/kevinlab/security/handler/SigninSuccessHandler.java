...
public class SigninSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
     ...
     //public static String DEFAULT_TARGET_PARAMETER = "spring-security-redirect-login-success";
     ...
     public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication auth) throws IOException, ServletException {
          ...
          System.out.println("SUCCESS : "+auth.toString()+"|| accept : "+accept+" || roles : "+roles.toString());
